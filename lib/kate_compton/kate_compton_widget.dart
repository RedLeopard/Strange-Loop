...
class KateComptonWidget extends StatefulWidget {
  KateComptonWidget({Key key}) : super(key: key);

  @override
  _KateComptonWidgetState createState() => _KateComptonWidgetState();
}

class _KateComptonWidgetState extends State<KateComptonWidget> {
